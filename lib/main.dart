...
import 'package:absenqu_flutter/screens/slip_gaji/slip_gaji_page.dart';
import 'package:absenqu_flutter/screens/reimburse/reimburse_screen.dart';
import 'package:absenqu_flutter/screens/challenge/challenge_employee_page.dart';
import 'package:absenqu_flutter/screens/olahraga/olahraga_challenge_page.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
       ...
       // SLIP GAJI
        '/slipgaji': (context) => const SlipGajiPage(),
        '/slip_gaji': (context) => const SlipGajiPage(),

        // REIMBURSE
        '/reimburse': (context) => const ReimburseScreen(),

        // CHALLENGE & OLAHRAGA
        '/challenge': (context) => const ChallengeEmployeePage(),
        '/olahraga': (context) => const OlahragaChallengePage(),
      },
    );
  }
}
