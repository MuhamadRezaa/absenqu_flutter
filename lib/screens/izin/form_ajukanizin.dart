...
class FormAjukanizin extends StatefulWidget {
  const FormAjukanizin({super.key});

  @override
  State<FormAjukanizin> createState() => _FormAjukanizinState();
}

class _FormAjukanizinState extends State<FormAjukanizin> {
            ...
            children: [
                        ...
                        children: [
                          Expanded(
                            child: GestureDetector(
                              onTap: onImageTap,
                              child: child, // This is the ImgBorderDash
                            ),
                          ),
                  ...
                  child: const Center(
                    child: Row(
                      ...
                      children: [
                        ...
                        SizedBox(width: 8),
                        Icon(Icons.create_sharp, size: 24, color: Colors.black),
                      ],
                    ),
                  ),
                ),
              ...
              if (pickedImagePath == null)
                GestureDetector(
                  onTap: () {
                    ScaffoldMessenger.of(context).showSnackBar(
                      const SnackBar(content: Text('Ajukan Izin dahulu')),
                    );
                  },
                  child: Container(
                    width: double.infinity,
