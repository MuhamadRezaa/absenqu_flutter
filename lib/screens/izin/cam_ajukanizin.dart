...
class CamAjukanIzin extends StatefulWidget {
  const CamAjukanIzin({super.key});

  @override
  State<CamAjukanIzin> createState() => _CamAjukanIzinState();
}

class _CamAjukanIzinState extends State<CamAjukanIzin>
                              ...
                              Expanded(
                                child: ElevatedButton(
                                  ...
                                  style: ElevatedButton.styleFrom(
                                    backgroundColor: const Color(0xFFBDF8F7),
