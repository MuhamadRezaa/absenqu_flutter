...
class AbsenMasuk3Screen extends StatefulWidget {
  const AbsenMasuk3Screen({super.key});

  @override
  State<AbsenMasuk3Screen> createState() => _AbsenMasuk3ScreenState();
}

class _AbsenMasuk3ScreenState extends State<AbsenMasuk3Screen> {
